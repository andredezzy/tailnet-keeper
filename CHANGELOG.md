...
- Answer the steady-state completeness check from one read of the routing table per family instead of one kernel lookup per relay. The five-minute run dropped from 9s to under one second.
